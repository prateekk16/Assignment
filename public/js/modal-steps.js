/* Script taken from http://www.jqueryscript.net/demo/Create-Step-By-Step-Modal-with-jQuery-Bootstrap/src/jquery-bootstrap-modal-steps.js */
        ...
        $modal.find('.js-btn-step').on('click', function(){
            ...
            if ($btn.attr('data-step') === 'complete'){
                ...
                if($("#category-name").val().length || ($("#all-categories").val() != " ")){
                    ...
                    swal("Oops!", "You forgot to enter the Category name", "error"); 
                }
